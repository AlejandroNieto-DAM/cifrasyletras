...
usoConjunto: src/usoconjunto.cpp src/conjuntoletras.cpp
	g++ -std=c++11 -I$(INCLUDE) -o bin/usoConjunto src/usoconjunto.cpp src/conjuntoletras.cpp

uc: usoConjunto
	bin/./usoConjunto datos/letras.txt

usoDiccionario: src/testDiccionario.cpp src/diccionario.cpp
	g++ -std=c++11 -I$(INCLUDE) -o bin/usoDiccionario src/testDiccionario.cpp src/diccionario.cpp
